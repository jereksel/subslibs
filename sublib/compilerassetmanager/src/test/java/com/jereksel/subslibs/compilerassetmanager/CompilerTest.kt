package com.jereksel.subslibs.compilerassetmanager
...
import com.jereksel.subslibs.models.Type2Extension
import com.jereksel.subslibs.models.Type3Extension
...
class CompilerTest {
    ...
    ) = aapt.compileTheme(assetManager, ThemeToCompile("com.app.app", "com.app.app", app, "com.app.app", type1Data, type2, type3, 0, ""), temp)
